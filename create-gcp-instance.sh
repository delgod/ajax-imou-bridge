...
echo ""
echo "3. Install the SIA Receiver package from PyPI (or GitHub):"
...
echo "   sudo cp sia-receiver.conf /etc/sia-receiver.conf"
echo "   sudo cp sia-receiver.service /etc/systemd/system/"
echo ""
echo "5. Enable and start the systemd service:"
echo "   sudo systemctl daemon-reload"
echo "   sudo systemctl enable --now sia-receiver.service"
echo ""
echo "6. Your SIA receiver will be accessible at: $EXTERNAL_IP:12128"
echo ""
